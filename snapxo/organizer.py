...
def organize_into_folders(
    ...
    # Sort files into year or year-month folders with clean names. Returns the
    # file_index the later steps and the manifest are built from. On resume only
    # the copying is skipped, the index is always built in full.
    ...
    for mf in sorted_files:
        ...
        file_index.append({
            ...
            "ext": new_ext,
            "uuid": mf.uuid,
            # Only chat media carries a Media ID that chat_history.json refers to
