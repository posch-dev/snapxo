...
from ..parts.shared import date_format_css, date_format_js, date_format_picker_html, split_timestamp
...
def build_chats_html(records: list[dict]) -> str:
    ...
    # A PDF viewer cannot be sent to an anchor, so a hit only opens the file.
...
<div class="nav"><a href="index.html">Overview</a><a href="gallery.html">Media gallery</a><a href="stats.html">Statistics</a><a href="map.html">Snap Map</a></div>
<div class="wrap">
__NOTE__
<div class="toolbar">
