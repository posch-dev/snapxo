# How far a run got, so an interrupted one picks up where it stopped.
...
def config_fingerprint(config) -> str:
    # A checkpoint from different inputs or filters must not be reused.
...
class Checkpoint:
    ...
    def flush(self):
        ...
        # A sibling first, so being killed mid-write leaves the old one intact.
